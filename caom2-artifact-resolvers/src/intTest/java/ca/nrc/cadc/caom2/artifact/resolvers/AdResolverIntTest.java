 ...
 * @author yeunga
 */
public class AdResolverIntTest {
    private static final Logger log = Logger.getLogger(AdResolverIntTest.class);

    static {
        Log4jInit.setLevel("ca.nrc.cadc", Level.INFO);
    }

    String VALID_URI = "ad:IRIS/I008B4H0.fits";

    AdResolver adResolver = new AdResolver();

    public AdResolverIntTest() {
    }
    ...
    public void testValidSiteUrl() throws Exception {
        ...
        try {
            URL url = adResolver.toURL(new URI(VALID_URI));
